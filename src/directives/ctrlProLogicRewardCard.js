(function (angular, undefined) {
  ...
  angular.module('gsn.core')
    .controller(myDirectiveName, ['$scope', 'gsnProfile', 'gsnApi', 'gsnStore', '$timeout', '$http', '$filter', myController])
  ...
  ////
  function myController($scope, gsnProfile, gsnApi, gsnStore, $timeout, $http, $filter) {
